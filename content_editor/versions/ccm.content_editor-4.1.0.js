...
( function () {
  ...
  var component = {
    ...
    config: {
      ...
      html2json: [ "ccm.component", "https://ccmjs.github.io/mkaul-components/html2json/versions/ccm.html2json-2.0.0.js" ],
    ...
    Instance: function () {
      ...
      this.init = async () => {
        ...
        function collectDependencies( node ) {
          ...
          [ ...node.children ].map( child => {
            ...
            config.parent = self;
            config.root = child;
            self.data.dependencies.push( $.isComponent( component ) ? [ component, config ] : [ 'ccm.start', component, config ] );
      ...
      this.start = async () => {
        ...
        $.setContent( editor_div, dataset.inner || 'Edit here' );
