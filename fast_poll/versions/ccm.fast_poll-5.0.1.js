  ...
  var component  = {   // const not working in Safari
    ...
    config: {
      ...
      choices: [
        ...
        {
          // question: 'Frage als Überschrift gezielt zu dieser Auswahl:',
          agil: 'Individuen und Interaktionen',
          plan: 'Prozesse und Werkzeuge'
        },
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        const main_elem = $.html(self.html.main, { intro: self.intro });
        ...
        function render_next_choice(number_of_choice) {
          ...
          if (self.questions && self.questions[number_of_choice - 1]) {
            title.innerHTML = self.questions[number_of_choice - 1];
          }
        ...
        function onFinish() {
          ...
          choices.innerText = '';
          const newChild = $.html(self.html.choice, { label: self.outro });
