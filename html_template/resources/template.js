...
* https://github.com/WebReflection/backtick-template/blob/master/esm/index.js
* https://github.com/WebReflection/backtick-template/blob/master/LICENSE.txt
* */
export function template(fn, $str, $object) {'use strict';
