  ...
  var component  = {
    ...
    config: {
      ...
      html: {
        ...
        row: { tag: 'tr', inner: [ { tag: 'td', inner: '%nr%' }, { tag: 'td', inner: '%von%' }, { tag: 'td', inner: '%bis%' }, { tag: 'td', inner: '%dauer%' }, { tag: 'td', inner: '%ticket%' }, { tag: 'td', inner: '%license%' }, { tag: 'td', inner: '%preis%' } ] },
      ...
      this.start = async () => {
        ...
        async function oninput( e ) {
          ...
          switch( this.classList.toString() ){
            case "max":
              await garage.add_image( parseInt( this.value ) - garage.max );
