    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        class Car {
          ...
          toArray(){
            const list = [ this.nr, this.timer, this._duration, this.price(), this.hash(), this.color(), this.space, this.client_category, this.vehicle_type, this.license, this.beginTime() ];
