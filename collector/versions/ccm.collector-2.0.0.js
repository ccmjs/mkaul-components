 ...
 * @changes
 * version 2.0.0 03.10.2020 add layout
...
( () => {
  ...
  const component = {
    ...
    config: {
      ...
      // CSS on list items does not work here, because list items are outside Shadow DOM
            ...
            if ( totalLength > self.min_input_length ){
              ...
              dataset = namedInputs.reduce( ( rec, input ) => {
                  ...
                  return rec },
                {
                  ...
                  author: isLecturer( self.user.data().user ) ? "lecturer" : "student"
                }
              );
