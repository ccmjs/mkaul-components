  ...
  var component = {
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        function pseudonym(){
          return `${navigator.appVersion};${navigator.hardwareConcurrency};${navigator.deviceMemory};${JSON.stringify(navigator.languages)};${navigator.product};${navigator.productSub};${navigator.userAgent};${navigator.vendor};`;
        }
