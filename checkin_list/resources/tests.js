...
/**
 * @overview unit tests of ccm component for checkin_list
...
ccm.files[ 'tests.js' ] = {
  setup: ( suite, callback ) => {
    suite.ccm.component( '../checkin_list/ccm.checkin_list.js', component => {
  ...
  fundamental: {
    tests: {
      componentName: suite => {
        suite.component.instance( instance => suite.assertSame( 'checkin_list', instance.component.name ) );
      }
    }
  },
  tests: {
    oneInput: suite => {
      suite.component.start( {
        ...
        instance.element.querySelector( '#checkin_list' ).click();
      } );
    }
  }
};
