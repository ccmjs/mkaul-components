...
/**
 * @overview unit tests of ccm component for quiz_gen
...
ccm.files[ 'tests.js' ] = {
  setup: ( suite, callback ) => {
    suite.ccm.component( '../quiz_gen/ccm.quiz_gen.js', component => {
  ...
  fundamental: {
    tests: {
      componentName: suite => {
        suite.component.instance( instance => suite.assertSame( 'quiz_gen', instance.component.name ) );
      }
    }
  },
  tests: {
    oneInput: suite => {
      suite.component.start( {
        ...
        instance.element.querySelector( '#quiz_gen' ).click();
      } );
    }
  }
};
