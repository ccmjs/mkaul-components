...
( () => {
  ...
  const component = {
    ...
    config: {
      ...
      user:   [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.3.0.js", { realm: "hbrsinfkaul", ccm: "https://ccmjs.github.io/ccm/versions/ccm-24.2.0.js" } ],
