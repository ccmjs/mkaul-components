...
/**
 * @overview unit tests of ccm component for excel
...
ccm.files[ 'tests.js' ] = {
  setup: ( suite, callback ) => {
    suite.ccm.component( '../excel/ccm.excel.js', component => {
  ...
  fundamental: {
    tests: {
      componentName: suite => {
        suite.component.instance( instance => suite.assertSame( 'excel', instance.component.name ) );
      }
    }
  },
  tests: {
    oneInput: suite => {
      suite.component.start( {
        ...
        instance.element.querySelector( '#excel' ).click();
      } );
    }
  }
};
