  ...
  var component = {
    ...
    Instance: function () {
      ...
      this.init = async () => {
        ...
        if ( self.process_this_result
          && typeof self.process_this_result === 'string'
          && window[self.process_this_result] ){

          self.process_this_result = window[self.process_this_result];
        }

        if ( self.process_all_results
          && typeof self.process_all_results === 'string'
          && window[self.process_all_results] ){

          self.process_all_results = window[self.process_all_results];
        }
