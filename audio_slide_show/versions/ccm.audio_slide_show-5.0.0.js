...
( () => {
  ...
  const component = {
    ...
    config: {
      ...
      audio_player: [ "ccm.component", "https://ccmjs.github.io/mkaul-components/audio_player/versions/ccm.audio_player-4.0.0.js" ],
      ...
      pdf_viewer: [ "ccm.component", "https://kaul.inf.h-brs.de/ccmjs/tkless-components/pdf_viewer/versions/ccm.pdf_viewer-6.1.0.js", {
        scale: 1,
        routing: [ "ccm.instance", "https://kaul.inf.h-brs.de/ccmjs/akless-components/routing/versions/ccm.routing-2.0.5.js" ],
        ccm: 'https://ccmjs.github.io/ccm/versions/ccm-25.5.3.min.js',
      ...
      collector: [ "ccm.component", "https://kaul.inf.h-brs.de/ccmjs/mkaul-components/collector/versions/ccm.collector-2.0.0.js", {
        ccm: "https://ccmjs.github.io/ccm/versions/ccm-25.5.3.min.js",
        helper: [ "ccm.load", "https://ccmjs.github.io/akless-components/modules/versions/helper-6.0.0.min.mjs" ],
        ...
        "html.link": {
          tag: "li",
          class: "%author%",  // ToDo: style Lecturer differently
          inner: "%message%"
        },
        retrieve_on_start: true,
        replacer: function( name, value ){ return value.split("\n").join("<br>\n").replace( /(https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*))/ig, ' <a href="$1" target="_blank" rel="noopener">$1</a> ' ); },
        data: {
          store: [ "ccm.store", { name: "se_ss20_slides_qa", url: "https://ccm2.inf.h-brs.de" } ]
        },
        user:   [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.7.0.js", { realm: "hbrsinfpseudo", "logged_in": true } ],
        onfinish: {
          store: {
            "settings": {
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        [ collector, audio_player, recorder ] = await Promise.all([
           ...
           self.collector.start({ root: collector_div, num: slide_num, parent_node: collector_div.parentElement, name: self.pdf.slice(self.pdf.lastIndexOf('/')+1,self.pdf.lastIndexOf('.')) }),
        ...
        audio_player && audio_player.setFinish( () => {
          const period = check_auto_slide_proceed();
          if ( period ) {
            setTimeout( () => {
        ...
        function check_auto_slide_proceed(){
          if ( self.global_settings ) {
            const period = self.global_settings.getNumber('slide_pause');
            if ( self.global_settings.getBool('auto_slide_proceed') ){
              if ( period && period >= 0 ){
                return period;
              } else {
                return 1;
